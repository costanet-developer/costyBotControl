...
\restrict ajVHhF0gSBcrfW78iD3gB1GQ2oO2fRJQCaP2iYURSBcghBjbYEL8THAuXbWd06l
...
4	2026_07_30_113553_create_auditoria_logs_table	1
5	2026_07_30_161812_create_permission_tables	1
\.
...
COPY public.users (id, nombre, apellido, email, email_verified_at, password, activo, bloqueado, intentos_fallidos, ultimo_acceso, remember_token, created_at, updated_at, deleted_at) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.auditoria_logs_id_seq', 29, true);
...
\unrestrict ajVHhF0gSBcrfW78iD3gB1GQ2oO2fRJQCaP2iYURSBcghBjbYEL8THAuXbWd06l
